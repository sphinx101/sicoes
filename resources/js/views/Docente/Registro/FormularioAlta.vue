<template>
  <div class="col-md-12">
    <div class="card bg-light mb-3 border-secondary">
      ...
      <form @submit.prevent="GuardarDatos" enctype="multipart/form-data">
        <div class="card-body">
          <template>
            <div class="row">
            ...
            <div class="form-group col-md-4">
              <label for="photo">Selecciona foto del Docente:</label>
              <input
                @change="selectPhoto"
                type="file"
                id="photo"
                name="photoDocente"
                data-initial-preview="http://sicoes.homestead/storage/photos/docentes/avatar-user.png"
                accept="image/*"
              />
            </div>
          </template>
...
export default {
  ...
  methods: {
    GuardarDatos() {
      ...
      formData.append("centrotrabajo_id", this.form.centrotrabajo_id);
      formData.append("rfc", this.form.rfc);
      formData.append("curp", this.form.curp);
      formData.append("nombre", this.form.nombre);
      formData.append("appaterno", this.form.appaterno);
      formData.append("apmaterno", this.form.apmaterno);
